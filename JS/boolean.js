    ...
    async function createPost() {
        ...
        document.querySelector('#allPostsWrapper').innerHTML = `<div class ="single-post" data-post_id="${post.id}">
                                                                ...
                                                                <div class="post-actions">
                                                                    ...
                                                                    <div>
                                                                        <button onclick="likePost(this)" class ="likePostJS like-btn"><span>${post.likes}</span>True</button>
                                                                        <button onclick="dislikePost(this)" class ="dislikePostJS dislike-btn"><span>${post.dislikes}</span>False</button>
        ...
        async function getPostUser(post) {
            ...
            document.querySelector('#allPostsWrapper').innerHTML = `<div class ="single-post" data-post_id="${post.id}">
                                                                    ...
                                                                    <div class="post-comments">
                                                                            <form>
                                                                                <input placeholder="Comment..." type="text">
                                                                                <button  onclick="commentPostSubmit(e)">Comment</button>
                                                                            </form>
                                                                    </div>
                                                                    ` + html;
        }
